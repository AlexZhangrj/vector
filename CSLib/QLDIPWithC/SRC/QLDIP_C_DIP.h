...
static const uint32_t QLDIP_C_Node_ProtoFooterVerifyCode     = UINT32_MAX;//4294967295
...
static const uint32_t QLDIP_C_Node_ProtoBodyLenLen              = 4;
static const uint32_t QLDIP_C_Node_ProtoBodyCountLen            = 2;
...
static const uint32_t QLDIP_C_Node_ProtoVersion     = 1;

static const uint32_t QLDIP_C_DIP_ObjByte_LenLen = sizeof(uint32_t);


//error code
static const QLDIP_C_ErrorCode QLDIP_C_ErrorCode_DIP_ByteNull = (0xff << 8) + 3;
static const QLDIP_C_ErrorCode QLDIP_C_ErrorCode_DIP_ByteVerifyFaild = (0xff << 8) + 4;
...
}QLDIP_C_NodeProtoHeader;
typedef QLDIP_C_NodeProtoHeader * QLDIP_C_NodeProtoHeaderRef;
...
typedef struct {
    uint32_t bodyLen;
    QLDIP_C_Byte * bodyByte;
}QLDIP_C_NodeProtoBodyItem;
typedef QLDIP_C_NodeProtoBodyItem * QLDIP_C_NodeProtoBodyItemRef;

typedef struct {
    QLDIP_C_NodeBase nodeBase;
    uint32_t footerVerifyCode;
}QLDIP_C_NodeProtoFooter;
typedef QLDIP_C_NodeProtoFooter * QLDIP_C_NodeProtoFooterRef;

typedef struct {
    QLDIP_C_NodeBase nodeBase;
    QLDIP_C_NodeProtoHeader header;
    QLDIP_C_NodeProtoBody body;
    QLDIP_C_NodeProtoFooter footer;
}QLDIP_C_NodeProto;
...
uint32_t QLDIP_C_DIPObjByteLen(QLDIP_C_Obj * theObj);
